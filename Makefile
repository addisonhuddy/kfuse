.PHONY: all build test test-race test-fuse test-install integration-test local-up local-demo local-down vet lint fmt fmt-check docker-build release-snapshot clean
